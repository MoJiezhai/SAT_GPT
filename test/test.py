...
if __name__ == "__main__":
    Eval={
        'main_path':'/home/wjq/SAT_GPT/mp52_com_data',
        'traj_train':'/home/wjq/SAT_GPT/mp52_com_data/target/train.traj',
        'traj_val':'/home/wjq/SAT_GPT/mp52_com_data/target/val.traj',
        'n_samples':1,
        'match_para':{
            'stol': 0.5,
            'angle_tol': 10,
    ...
    if os.path.exists(pred_path) and os.path.exists(true_path):
        ...
        for i in track(range(len(gen_frames)), description="PreProcessing all frames"):
            ...
            #ats_pred.set_scaled_positions(ats_true.get_scaled_positions())
